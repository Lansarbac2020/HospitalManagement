...
{
    /// <inheritdoc />
    public partial class dbupdatedg : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacultyMemberFacultyId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FacultyMemberFacultyId,
            ...
            migrationBuilder.InsertData(
                table: "Departments",
                columns: new[] { "DepartmentId", "AvailableBeds", "DepartmentName", "Description", "FacultyMemberFacultyId", "FacultyMemberId", "PatientCount" },
                values: new object[,]
                {
                    { 1, 0, "Pediatric Emergency", null, null, null, 0 },
                    { 2, 0, "Pediatric Intensive Care", null, null, null, 0 }
                });

            migrationBuilder.InsertData(
                table: "Assistants",
                columns: new[] { "AssistantId", "Address", "DepartmentId", "Email", "FirstName", "LastName", "Phone" },
                values: new object[,]
                {
                    { 1, "123 Elm St, Springfield", 1, "john.doe@example.com", "John", "Doe", "555-1234" },
                    { 2, "456 Oak St, Springfield", 1, "jane.smith@example.com", "Jane", "Smith", "555-5678" },
                    { 3, "789 Pine St, Springfield", 2, "emily.johnson@example.com", "Emily", "Johnson", "555-8765" }
                });
